...
| Light gray | `#f4f2ed` | Functional surfaces: key-figure tiles, image regions, summary panels |
| Dark gray | `#403b34` | Secondary text |
...
- Body: Inter, 16.5–20 px, 1.6 line height, `#403b34` for secondary copy, `#15130f` for primary.
...
- The dark surface: the theme glyph is in the header, the dark palette is not yet defined.
- Photography: chosen as a warmth carrier, but the pages are type-only and reserve gray regions for images.
...
| `Cream options.dc.html` | The four cream candidates; C1 was chosen |
| `Action rules.dc.html` | The action tiers, as presented |
