...
```markdown
## Design system — Ağustos UI kit (v5.0.1)
...
https://raw.githubusercontent.com/Agustos-Teknoloji/DESIGN-agustos/v5.0.1/ui/UI-KIT.md and follow it.
...
```markdown
This project's UI is the Ağustos Design System. Read https://raw.githubusercontent.com/Agustos-Teknoloji/DESIGN-agustos/v5.0.1/ui/UI-KIT.md before you write or
