...
```markdown
## Design system — Ağustos UI kit (v4.0.0)
...
https://raw.githubusercontent.com/Agustos-Teknoloji/DESIGN-agustos/v4.0.0/ui/UI-KIT.md and follow it.
...
Texture is optional. Flat pages without imagery must feel complete.
...
```markdown
This project's UI is the Ağustos Design System. Read https://raw.githubusercontent.com/Agustos-Teknoloji/DESIGN-agustos/v4.0.0/ui/UI-KIT.md before you write or
