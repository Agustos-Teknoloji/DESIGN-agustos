...
```markdown
## Design system — Ağustos UI kit (v5.0.0)
...
```markdown
This project's UI is the Ağustos Design System. Read https://raw.githubusercontent.com/Agustos-Teknoloji/DESIGN-agustos/v5.0.0/ui/UI-KIT.md before you write or
