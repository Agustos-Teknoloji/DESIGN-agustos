...
Prototypes with no build step may link the CDN copies. **Pin to `@v5.2.0`.** Never `@main` or `@latest`; an unpinned link restyles a live page the moment a token changes.
